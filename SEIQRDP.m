function [S,E,I,Q,R,D,P] = SEIQRDP(alpha,beta,beta_2,gamma,delta,lambda0,kappa0,Npop,E0,I0,Q0,R0,D0,t,lambdaFun,kappaFun)
% [S,E,I,Q,R,D,P] = SEIQRDP(alpha,beta,gamma,delta,lambda,kappa,Npop,E0,I0,Q0,R0,D0,t,lambdaFun,kappaFun)
...
lambda = lambdaFun(lambda0,t);  % 随时间变化的lambda
kappa = kappaFun(kappa0,t);     % 随时间变化的kappa
...
for ii=1:N-1
    ...
    SE = Y(1,ii)*Y(2,ii);
    F = zeros(7,1);
    F(1:2,1) = [-beta/Npop;beta/Npop].*SI + [-beta_2/Npop;beta_2/Npop].*SE;
