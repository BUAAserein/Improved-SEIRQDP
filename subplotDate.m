...
for jjj = 4:4
    ...
    dt = 1; % time step
    time = datetime(2020,01,24):dt:datetime(2020,02,15);
    time2 = datetime(2020,02,16):dt:datetime(2020,06,15);
    ...
    lambda = lambdaFun(Lambda1,t);  % 随时间变化的lambda
    kappa = kappaFun(Kappa1,t);     % 随时间变化的kappa
    
    
    
    %     figure
    %
    %     semilogy(t,lambda,'r',t,kappa,'b');
    %
    %     ylabel('rate')
    %     xlabel('time (days)')
    %     leg = {'治愈率','死亡率'};
...
for jjj = 4:4
    ...
    dt = 1; % time step
    time = datetime(2020,01,24):dt:datetime(2020,03,01);
    time2 = datetime(2020,03,02):dt:datetime(2020,06,15);
...
for jjj = 4:4
    ...
    dt = 1; % time step
    time = datetime(2020,01,24):dt:datetime(2020,04,01);
    time2 = datetime(2020,04,02):dt:datetime(2020,06,15);
